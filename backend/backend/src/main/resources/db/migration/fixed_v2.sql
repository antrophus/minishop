...
-- Product 테이블 개선: 다양한 가격 유형 지원
ALTER TABLE products 
  CHANGE COLUMN price regular_price DECIMAL(12,2) NOT NULL,
  ADD COLUMN consumer_price DECIMAL(12,2) NOT NULL DEFAULT 0.0 AFTER regular_price,
  ADD COLUMN member_price DECIMAL(12,2) NOT NULL DEFAULT 0.0 AFTER consumer_price,
  ADD COLUMN description TEXT AFTER member_price,
